...
function saveData(name, value) {
    ...
    localStorage.setItem("accessLocal", JSON.stringify(accessData));

}

function deleteData(name) {

    accessData = JSON.parse(localStorage.getItem("accessLocal"));
...
function showData() {
    ...
    if(localStorage.getItem("accessLocal") && JSON.parse(localStorage.getItem("accessLocal")).length > 0) {
